...
export default function Newsletter() {
  ...
  return (
    <section>
      <div className="max-w-6xl mt-20 mx-auto px-4 sm:px-6" id="contact">
          ...
          <div className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">Envie-nos uma mensagem!</h3>
                <p className="text-gray-300 text-lg mb-6">Digite sua mensagem no campo de entrada, e ela será enviada diretamente para a gente pelo whatsapp.</p>
                ...
                <form className="w-full lg:w-auto">
                  ...
                  <p className="text-sm text-gray-400 mt-3">Não se preocupe, não enviaremos spam. 😊</p>
                </form>
              </div>
